...
Please copy the `ScyllaEstimation` folder. Choose a name for your study package, and change all references from 'ScyllaEstimation' to your name of choice in the package code. You could use Notepad++'s 'Find in files' option to do this automatically.
